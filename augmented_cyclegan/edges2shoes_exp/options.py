...
class TrainOptions(object):
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--name', default="augcgan_model", type=str, help='name of the experiment. It decides where to store samples and models')
        ...
        # supervised training
        self.parser.add_argument('--supervised', default=True, help='fraction of training data for supervised training')
