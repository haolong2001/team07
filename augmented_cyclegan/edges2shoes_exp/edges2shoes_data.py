...
def load_edges2shoes_(root):
    ...
    random.setstate(rand_state)
    start = 700
    devA = trainA[start: start+100]
    devB = trainB[start: start+100]
...
class AlignedIterator(object):
    ...
    def __init__(self, data_A, data_B, **kwargs):
        ...
        print("Sample size: ", self.num_samples, ", Batch size: ", batch_size)
...
class UnalignedIterator(object):
    ...
    def __init__(self, data_A, data_B, **kwargs):
        ...
        print("Sample size: ", self.num_samples, ", Batch size: ", self.batch_size)
